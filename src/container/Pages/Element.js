                            ...
                            <div className="row gallery-item">
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g1.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g1.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g2.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g2.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g3.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g3.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-6">
                                    <a href="assets/img/elements/g4.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g4.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-6">
                                    <a href="assets/img/elements/g5.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g5.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g6.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g6.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g7.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g7.jpg)' }} />
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a href="assets/img/elements/g8.jpg" className="img-pop-up">
                                        <div className="single-gallery-image" style={{ background: 'url(assets/img/elements/g8.jpg)' }} />
                                    </a>
                                </div>
                            </div>
                        </div>
